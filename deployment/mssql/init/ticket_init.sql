...
-- 1. ticket table
CREATE TABLE IF NOT EXISTS `event_ticket`.`ticket` (
...
CREATE TABLE IF NOT EXISTS `event_ticket`.`ticket_detail` (
                                                        `id` BIGINT(20)  NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
...
INSERT INTO `event_ticket`.`ticket` (`name`, `desc`, `start_time`, `end_time`, `status`, `updated_at`, `created_at`)
VALUES
...
INSERT INTO `event_ticket`.`ticket_item` (`name`, `description`, `stock_initial`, `stock_available`, `is_stock_prepared`, `price_original`, `price_flash`, `sale_start_time`, `sale_end_time`, `status`, `activity_id`, `updated_at`, `created_at`)
VALUES
